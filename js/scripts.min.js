 ...
 */
 var countingdata = 1;
 let provider, signer;
 const nftAddress = "0xfdb078b353a558830c24df515598a67b8e70a18e"
...
async function mintNow (){
  try{
    ...
    else message = 'Minting did not start yet! Keep trying :)';
    alert (message);
  }
}
...
async function totalMinted (){
  try{
    ...
    document.getElementsByClassName("totalminted")[0].innerText = `${minted}/50 Minted`
  } catch(err){
    console.log(err);
  }
}
